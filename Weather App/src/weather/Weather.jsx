...
const Weather = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-image bg-cover">
      <div className="w-full max-w-md bg-blue-100 bg-opacity-50 rounded-lg p-6">
